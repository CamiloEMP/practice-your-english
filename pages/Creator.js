import { FaLinkedin, FaGithub, FaGrinAlt, FaHeart } from 'react-icons/fa'
      ...
      <section className="mt-20 max-w-xl mx-auto">
        <div className="mb-20">
          <blockquote className="text-4xl font-bold italic text-center text-slate-900">
            Hello my name is
            <br />
            <span className="mt-4 before:block before:absolute before:-inset-1 before:-skew-y-2 before:bg-sky-400 relative inline-block">
          ...
          <div className="flex justify-center mt-6 text-4xl">
            <a href="https://github.com/CamiloEMP/" rel="noreferrer" target="_blank">
              <FaLinkedin className="mr-4 transition-colors hover:fill-sky-400 cursor-pointer" />
            </a>
            <a href="https://www.linkedin.com/in/camilo-mora/" rel="noreferrer" target="_blank">
              <FaGithub className="transition-colors hover:fill-sky-400 cursor-pointer" />
            </a>
          </div>
        </div>
        <div>
